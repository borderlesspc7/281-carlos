...
import KitTabs from "../../../pages/Obra/Kits/KitTabs/KitTabs";
import KitMaoObraForm from "../../../pages/Obra/Kits/KitMaoObraForm/KitMaoObraForm";
import KitMateriaisForm from "../../../pages/Obra/Kits/KitMateriaisForm/KitMateriaisForm";
import {
  AlertCircle,
  Layers,
  Plus,
...
const Kits = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      if (!target.closest(".kit-menu-container")) {
        setOpenMenuId(null);
      }
    };
  ...
  const handleEditKit = (kit: Kit) => {
    setOpenMenuId(null);
    // TODO: Implementar edição do kit
    console.log("Editar kit:", kit);
  };

  const toggleMenu = (kitId: string) => {
    setOpenMenuId(openMenuId === kitId ? null : kitId);
  };
          ...
          {kits.map((kit) => (
            <div key={kit.id} className="kit-card">
              <div className="kit-card-header">
                <div>
                  <span className="kit-vagao">
                    <Building2 size={18} />
                    Vagão {kit.vagaoNumero}
                  </span>
                </div>
                <div className="kit-menu-container">
                  <button
                    title="Opções"
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  {openMenuId === kit.id && (
                    <div className="kit-dropdown-menu">
                      <button
                        className="kit-menu-item kit-menu-item-edit"
                        onClick={(e) => {
                          e.stopPropagation();
                          handleEditKit(kit);
                        }}
                      ...
                      <button
                        className="kit-menu-item kit-menu-item-delete"
                        onClick={(e) => {
                          e.stopPropagation();
